...
function getShippingMessage(country, price, deliveryFee) {
    ...
    const theTotalCost = price;
    const costOfDeliveryOfGoods = deliveryFee;
    const totalPrice = theTotalCost + costOfDeliveryOfGoods;

    return `Shipping to ${countryOfDelivery} will cost ${totalPrice} credits`;
}
