...
function makeTransaction(quantity, pricePerDroid) {
    const quantityDroids = quantity;
    const pricePerOneDroid = pricePerDroid;
    const totalPrice = quantityDroids * pricePerOneDroid;

    return `You ordered ${quantityDroids} droids worth ${totalPrice} credits!`;
}
